...
open class ViewModelBase : ViewModel() {
    ...
    fun getSnakeBarMessageForLong(): MutableLiveData<Any> {
        return snackbarMessage
    }
     ...
     * @param message string object to display.
     */
    fun showSnackBarMessageForLong(message: Any) {
        snackbarMessage.value = message
    }
    ...
    fun callLogOutAPpi() {
        ...
        /*viewModelScope.launch(coroutineContext) {
            logoutResponse.value = ResponseHandler.Loading
            logoutResponse.value =
                userModuleRepository?.callLogOut("Android")
        }*/
    }
}